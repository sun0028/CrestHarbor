      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setModalState) => Padding(
          ...
          child: Column(
            ...
            children: [
              const Text("Complete Application", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(0xFFfff5f0))),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: const Color(0xFF0a0a0a), borderRadius: BorderRadius.circular(15), border: Border.all(color: Colors.white10)),
                  child: Row(
                    children: [
                      const Icon(Icons.picture_as_pdf, color: Color(0xFFf03e3e), size: 20),
                      const SizedBox(width: 12),
                      Expanded(child: Text(fileName, style: const TextStyle(color: Colors.white70, fontSize: 13))),
                      const Text("ATTACH", style: TextStyle(color: Color(0xFFf03e3e), fontWeight: FontWeight.bold, fontSize: 10)),
                    ],
                  ),
                ),
              ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        widget.job['title'] ?? "", 
                        style: const TextStyle(fontSize: 26, fontWeight: FontWeight.w900, color: Color(0xFFfff5f0), letterSpacing: -0.5)
                      ),
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: const TextStyle(color: Color(0xFFf03e3e), fontWeight: FontWeight.bold, fontSize: 12),
                          ),
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("COMPANY INSIGHT", style: TextStyle(color: Colors.white24, fontWeight: FontWeight.bold, fontSize: 8, letterSpacing: 1)),
                            const SizedBox(height: 10),
                            Text(widget.job['company_name'] ?? "", style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFFfff5f0))),
                      ...
                      ? Container(
                          ...
                          child: const Center(
                            child: Text(" APPLICATION SUBMITTED", 
                              style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontSize: 11, letterSpacing: 1)),
                          ),
                        )
                      : ElevatedButton(
                          ...
                          child: const Text("APPLY FOR JOB ", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.white)),
                        ),
                      const SizedBox(height: 40),
                    ],
                  ),
